...
https://www.geeksforgeeks.org/problems/print-the-pattern-set-1/1?page=1&category=pattern-printing&sortBy=submissions
...
class Solution {
	...
	fun printPattern(n: Int): ArrayList<Int> {
...
fun main() {
	...
	println(solution.printPattern(3))
